...
> 当前策划基线：[《深处的文明》GDD V3：被动城市经营 × 资源产业链 × 小队战术构筑](DeepCivilization_GDD_V3.md)。由根目录 V2 系统方案整合更名；`deprecated/` 下文档仅供历史参考。GDD 描述目标设计，以下 README 描述工程结构与实现状态。
...
> 进行时代的升级时，会把当前所有单位和建筑相应进化成下一个时代的产物，类似游戏帝国时代。因此产生收益。同时新的时代会解锁新的科技，兵种和升级，带来新的机会。因此提供一个有趣的权衡：
> 早升级，即时收益为负，但是科技轮次来的快，兵种容易高级，战未来
> 晚升级，即时收益为正，稳定战力提升
...
| `DeepCivilization_GDD_V3.md` | 当前游戏设计文档，描述游戏目标与玩法方向。 |
