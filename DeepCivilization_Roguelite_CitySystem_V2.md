...
> 真正的产品循环是：
是的，所以其实游戏核心是 第一核心模拟经营资源管理 + 第二核心rougelike战术搭配。 run不设置层数限制，向下会不断解锁新的环境，敌怪，资源，事件，入侵，经济，就像刷抖音视频一样。空间是有限资源，所以这种生产建筑代表牺牲前期战力换取资源的曲线，当然这里建设多个资源建筑好像是二次函数的增长曲线我再思考下。宣传视频的大方向，应该是（经营文明100年后我的变化）这种城镇推进感，以及相关的氛围塑造，还有第二重点是入侵事件的氛围塑造。我加入相邻位置效果，主要就是想让玩家建设的城镇看起来像一座城镇，典型的如磨坊周围建造麦田。中转站我确实没想太好。
...
城市本身就是这一局最大的一套 Roguelike Build。

而 Squad 则是它下面的第二层 Build。

这两个层级如果建立好，你的游戏系统会非常有辨识度。
...
最适合你的镜头不是频繁换地图，而是大量使用相同机位 Match Cut：
...
以资深发行和数值/系统策划的角度分析我发给你的草稿预案，分析其中值得深挖的地方，和存在风险的地方。轻量游戏想法

在钻头平台上建设一座城市，向下层挖掘，并且打怪，收集资源，建设城防和科技，造兵造塔，来打赢战斗继续前进。

宣传视频
1.先用limtus【【G2R2018】litmus* - Flashdance-哔哩哔哩】 https://b23.tv/vOqAMyH 
2.8bit音乐引入，给一些一眼就看得懂的实机战斗运营场景
3.卡点开始建筑建设切面，时代进化等，基地越来越复杂好看的时间线全景图，夹杂建筑玩法展示
4.前半段是保留建筑卡片与基地同屏显示效果，半段纯显示全景图，跟卡点切换，换周围多种的环境和时代的
5.下一阶段进入大群的士兵build 配合展示，技能特写展示，打击感展示，技能组合选择能力展示
6.下一阶段进入游戏的终极目标展示，多种生态，天气系统以及自然灾害展示，以及最终目标冲击性画面，结束

需要做市场调研，玩法类游戏，模拟经营和肉鸽

建筑数值设计

一级建筑

伐木工小屋蓝图，大小2 2 造价100木头20黄金，效果每次过关给20木头

步兵铁匠铺，大小2 2 造价100石头40黄金，效果每次过关消耗10木头10黄金给近战步兵小队加1攻击力buff

步兵兵营，大小2 2 造价80木头80石头，效果每次过关消耗40食物，给随机一个近战步兵小队加一个人

磨坊，大小2 2 造价120木头60石头，效果使临近麦田的产出食物加5，不叠加

麦田，大小1 1 造价20木头20食物，效果每次过关给5食物

采石场，大小2 2 造价80石头80木头，效果每次过关加10石头

金矿，大小2 2 造价100黄金60石头，效果每次过关加10黄金

厨房，大小2 2 造价120木头，效果每次过关消耗20食物使近战步兵加10血上限

步兵训练场，大小2 2 造价60木30金，效果过关时尝试话费100食物50知识，此后步兵获得跳劈技能自动释放并加10%血和攻击。触发成功后自身消失

事件场地，自然随机生成，可以选一个队伍去交互一次对这个队伍附魔。需要30石头或者30木头，能轻微增加武器的击退。以下所有事件场地都对交互队伍生效，并且类似风暴之城，需要几样东西之中的一个，越是强大的效果，越是需要高等级的素材里面选择。

事件场地，自然随机生成，附魔让当前队伍每杀死十个敌人，会尝试复活这只队伍中的一个人。

事件场地，自然随机生成，附魔让当前队伍的成员少承受25%的伤害向上取整

事件场地，自然随机生成，附魔让当前队伍给攻击对象附加百分之十伤害的流血，持续5秒

事件场地，自然随机生成，附魔让当前队伍的技能冷却加快百分之50

事件场地，自然随机生成，让当前队伍不会被击退

事件场地，自然随机生成，让当前队伍移动速度加快百分之30
---
